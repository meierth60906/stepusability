...
$vorbedingung = $_POST['inputPrecondition'];
$bereitgestellt = $_POST['inputProvidedData'];
$bestandenwenn = $_POST['inputPassedCondition'];
$abbruchwenn = $_POST['inputCancelCondition'];
$loesungsschritte = $_POST['inputSolutionSteps'];
...
$stid_tb = oci_parse($conn, "UPDATE TEXTBAUSTEIN SET BEREITG_DATEN='".$bereitgestellt."', VORBEDINGUNG='".$vorbedingung."', LOESUNGSSCHRITT='".$loesungsschritte."', BESTANDEN_WENN='".$bestandenwenn."', ABBRUCH_WENN='".$abbruchwenn."' WHERE AB_ID='".$t_id."'");
