...
echo "<li class='task item-hover' data-id='". $fetchRowCount[0] ."'>
    <div class='row p-3'>
        <div class='col-lg-12'>
        <a href='#testaufgaben' data-id='". $fetchRowCount[0] ."' onclick='editCcQuestion(this)' data-toggle='tooltip' data-placement='bottom' title='Frage bearbeiten' class='button-addTask link-noblue'>
