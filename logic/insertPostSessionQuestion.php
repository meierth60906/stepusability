...
echo "<li class='task item-hover aufgabenliste-task' data-id='". $fetchRowCount[0] ."'>
            <div class='row p-3'>
            <div class='col-lg-12'>
            <a href='#testaufgaben' data-id='". $fetchRowCount[0] ."' onclick='editPsQuestion(this)' data-toggle='tooltip' data-placement='bottom' title='Frage bearbeiten' class=' aufgabenliste-task-a button-addTask link-noblue'>
