...
while ($row = oci_fetch_array($stid, OCI_ASSOC+OCI_RETURN_NULLS)) {
    ...
    $data[] = "<li class='task item-hover aufgabenliste-task' data-id='". $row['ID'] ."'>
            <div class='row p-3'>
                <div class='col-lg-12'>
                    <a href='#testaufgaben' data-id='". $row['ID'] ."' onclick='loadPostSessionEval(this)' data-toggle='tooltip' data-placement='bottom' title='Frage bearbeiten' class='aufgabenliste-task-a button-addTask link-noblue'>
