...
$stid = oci_parse($conn, "SELECT * FROM (SELECT * FROM ABSCHNITT WHERE UT_ID = 39 AND ART_AB = 'Aufgabe' AND IN_SZENARIO IS NULL UNION SELECT * FROM ABSCHNITT WHERE UT_ID = 39 AND ART_AB = 'Szenario');");
oci_execute($stid);
