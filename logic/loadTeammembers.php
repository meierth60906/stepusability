...
$stid = oci_parse($conn, "SELECT * FROM PERSON WHERE STATUS = 'Laufend'");
oci_execute($stid);
...
if($fetchRowCount) {
    ...
    echo "<h1 id=\"noprojects\" class=\"mt-5 pt-5 text-muted text-center\">Es wurde niemand zum Projekt hinzugefügt.</h1>";
}
