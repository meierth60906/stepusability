...
$stid = oci_parse($conn, "INSERT INTO ABSCHNITT (ID, ART_AB, BESCHREIBUNG, UT_ID) values($id++ ,$art , $desc , $ut_id");
...
echo "<a href='#testaufgaben' onclick='editScenario()' data-toggle='tooltip' data-placement='bottom' title='Szenario bearbeiten' class='link-noblue'>" . ($item !== null ? htmlentities($item, ENT_QUOTES) : '&nbsp;') . "</a>";
echo "</div>";
